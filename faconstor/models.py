...
class ResourcePool(models.Model):
    ...
    certificate = models.CharField(
        "证书", blank=True, null=True, max_length=5000)
    specifications = models.CharField(
        "规格", blank=True, null=True, max_length=5000)
...
class ClientHost(models.Model):
    ...
    proxyClientID = models.CharField(
        "代理主机列表", blank=True, null=True, max_length=5000)
    creditInfo = models.CharField(
        "认证信息", blank=True, null=True, max_length=1000)
    agentTypeList = models.CharField(
        "代理类型列表", blank=True, null=True, max_length=2000)
...
class DataSet(models.Model):
    ...
    instanceName = models.CharField(
        "实例名称", blank=True, null=True, max_length=500)
