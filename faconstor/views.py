...
def phyproconfig(request, funid):
    if request.user.is_authenticated():
        ...
        return render(request, 'phyproconfig.html',
                      {'username': request.user.userinfo.fullname, "backupresource": backups,
                       "fileschduleresource": fileschdules, "dbschduleresource": dbschdules, "pagefuns": getpagefuns(funid, request=request)})
    else:
        return HttpResponseRedirect("/login")
...
def resourcepool(request, funid):
    if request.user.is_authenticated() and request.session['isadmin']:
        return render(request, 'resourcepool.html',
                      {'username': request.user.userinfo.fullname, "resourcepoolpage": True, "pagefuns": getpagefuns(funid, request=request)})
    else:
        return HttpResponseRedirect("/login")
...
def backupresource(request, funid):
    if request.user.is_authenticated() and request.session['isadmin']:
        return render(request, 'backupresource.html',
                      {'username': request.user.userinfo.fullname, "backupresourcepage": True, "pagefuns": getpagefuns(funid, request=request)})
    else:
        return HttpResponseRedirect("/login")
...
def schduleresource(request, funid):
    if request.user.is_authenticated() and request.session['isadmin']:
        return render(request, 'schduleresource.html',
                      {'username': request.user.userinfo.fullname, "schduleresourcepage": True, "pagefuns": getpagefuns(funid, request=request)})
    else:
        return HttpResponseRedirect("/login")
